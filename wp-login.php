...
})(window,document,'script','dataLayer','GTM-KNC25DD');</script>
<!-- End Google Tag Manager -->
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Log Masuk &lsaquo; aroma-walet &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/installwp/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log Masuk">
									<input type="hidden" name="redirect_to" value="http://localhost/installwp/wp-admin/?simply_static_page=2783">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="/lost-password">Lupa sandi Anda?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Pergi ke aroma-walet</a>		</p>
			</div>
...
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/installwp\/wp-admin\/admin-ajax.php"}};</script>
<script src="/wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"ed7b1c52fc"};</script>
